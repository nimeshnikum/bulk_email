...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { account_id: @reference.account_id, company: @reference.company, contact: @reference.contact, email: @reference.email, phone: @reference.phone }
    end
  ...
  test "should update reference" do
    put :update, id: @reference, reference: { account_id: @reference.account_id, company: @reference.company, contact: @reference.contact, email: @reference.email, phone: @reference.phone }
    assert_redirected_to reference_path(assigns(:reference))
  end
