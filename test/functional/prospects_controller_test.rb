...
class ProspectsControllerTest < ActionController::TestCase
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post :create, prospect: { company_name: @prospect.company_name, email1: @prospect.email1, email2: @prospect.email2, phone: @prospect.phone, remarks: @prospect.remarks, status: @prospect.status, type: @prospect.type }
    end
  ...
  test "should update prospect" do
    put :update, id: @prospect, prospect: { company_name: @prospect.company_name, email1: @prospect.email1, email2: @prospect.email2, phone: @prospect.phone, remarks: @prospect.remarks, status: @prospect.status, type: @prospect.type }
    assert_redirected_to prospect_path(assigns(:prospect))
  end
