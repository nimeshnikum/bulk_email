...
class EmailTemplatesControllerTest < ActionController::TestCase
  ...
  test "should create email_template" do
    assert_difference('EmailTemplate.count') do
      post :create, email_template: { body: @email_template.body, from: @email_template.from, name: @email_template.name, subject: @email_template.subject }
    end
  ...
  test "should update email_template" do
    put :update, id: @email_template, email_template: { body: @email_template.body, from: @email_template.from, name: @email_template.name, subject: @email_template.subject }
    assert_redirected_to email_template_path(assigns(:email_template))
  end
